...
<body id="about" class="inner_page" data-spy="scroll" data-target="#navbar-wd" data-off="98">
	...
	<div class="container">
		...
		<table class="table table-sm">
			<thead>
				<tr>
					<td colspan="2">
					<a href='#' id="testBtn" class="btn"><i class="fa fa-map-marker" style="font-size:25px; background:#fff;color:#f2184f;" aria-hidden="true"></i></a>
					<span > <b id="realresult">&nbsp; 어디를 방문하셨나요?</b></span>
	    		...
	    		<tr>
	     			<td>평점</td>
	     			<td><input type="radio" name="score" value="5">5
	    		...
	    		<tr>
	     			<td>내 용(총평)</td>
	     			<td><textarea name="content" id="content" rows ="8" cols="100" placeholder="하고픈 말을 적으세요"></textarea></td>
		...
		<input type="submit" id="submitbtn" class="btn btn-success" value="글쓰기" />
		</form>
	</div>
...
var markerPosition  = new kakao.maps.LatLng(35.1631872,129.0633782); 
var placePosition = new kakao.maps.LatLng(35.1631872,129.0633782);
//마커를 생성합니다
...
$(function(){	
	...
	$('#modalY').click(function(){		
		...
		$('#realresult').empty();
		$('#realresult').append(data1.documents[s].place_name);
		console.log(s)
	...
	$('#btn1').click(function(){//버튼을 클릭하면
		var a = $('#search').val();
		//ps.keywordSearch(a, placesSearchCB); //서치에 입력한 키워드를 가져옴		
		$.ajax({ //ajax 실행시킴
		    type: 'GET',
