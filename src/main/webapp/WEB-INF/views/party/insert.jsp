...
<jsp:include page="/WEB-INF/views/menu.jsp"></jsp:include>
	...
	<div class="container">
	<form action="${pageContext.request.contextPath}/party/insert" method="post" enctype="multipart/form-data">
		<h4>동행자 글쓰기</h4>
		<table class="table table-sm">
			<thead>
				<tr>
					...
					<input autocomplete="off" type="text" style="cursor:pointer;padding: 10px; border:0px; font-weight: bold;" required name="realresult" id="realresult" placeholder="어디를 방문하시나요?">
				...
				<tr>				
					<td>제목</td>				
					<td><input type="text" name="ptytitle" placeholder="글제목"  style="border:none; width:70%"/></td>
				</tr>
				
				<tr>
					<td>내용</td>				
					<td><textarea id="content" name="ptycontent" rows ="10" style="border:none; width:80%" cols="100"placeholder="하고픈 말을 작성해주세요"></textarea></td>
				</tr>
				<tr>
	     			<td>이미지</td> 
		...
		$.ajax({ //ajax 실행시킴
		    ...
		    for (var i=0 ;i<n;i++){//데이터 길이만큼 반복 수행
			    $('#resulttable').append(//테이블에 추가하기
					    ...
					    '</td><td style="text-align:left; vertical-align:middle; text-overflow:ellipsis; overflow:hidden; white-space:nowrap;">'+data.documents[i].category_name+
					    '</td></tr></table>')		    
