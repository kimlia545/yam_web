...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
	...
	<div class="container">
	<div class="footer_blog full" style="text-align:center; margin-left: 280px">
		<h3>LOGIN</h3>
		 <div class="newsletter_form">
	    <form action="${pageContext.request.contextPath}/member/loginProcess" method="post">
	       <input type="text" style="border:1px solid black;width:300px;" placeholder="Your ID" name="username"/><br/>
		   <input type="password" placeholder="Your Password" style="border:1px solid black;width:300px;"name="password" required /><br/> 
